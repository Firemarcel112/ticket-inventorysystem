...
@section("content")
    ...
    <div class="ml-4 sm:ml-0 mb-8">
        ...
        <div id="BearbeitenMain">
            <form class="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]" method="POST" action="{{route('inventorymodelPost', $assetmodel->id)}}">
                @csrf
                <x-form.input
                    label="Modellname"
                    inputName="name"
                ...
                <x-form.input
                    ...
                    :value="$assetmodel->website"
                    setRequired="0"
                ></x-form.input>

                <div class="formButtons">
                    <x-button content="Speichern" colorType="success"></x-button>
                    <x-button type="1" :link="route('inventory.model.dashboard')" content="Abbrechen" colorType="danger"></x-button>
                </div>
            </form>
        </div>
    </div>
