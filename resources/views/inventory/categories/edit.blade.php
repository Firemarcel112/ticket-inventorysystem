...
@section("content")
    ...
    <div class="ml-4 sm:ml-0 mb-8">
        ...
        <div id="BearbeitenMain">
            <form class="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]" method="POST" action="{{route('inventorycategoriesPost', $assetcategory->id)}}">
                @csrf
                <x-form.input
                    label="Kategorie"
                    inputName="name"
                ...
                <div class="formButtons">
                    ...
                    <x-button type="1" :link="route('inventory.categories.dashboard')" content="Abbrechen" colorType="danger"></x-button>
                </div>
