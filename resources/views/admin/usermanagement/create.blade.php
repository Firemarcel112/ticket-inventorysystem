...
@section("content")
    <div class="ml-4 sm:ml-0 mb-8">
        ...
        <div id="BearbeitenMain">
            <form class="userCreate w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]" method="POST" action="{{ route('usercreatePost') }}">
                @csrf
                <x-form.input
                    label="Benutzername"
                    inputName="username"
                ...
                <div class="relative">
                    ...
                    <input name="password" id="password" required type="password" class="w-full" placeholder="Passwort eingeben" />
                </div>

                <label for="password_confirmation">Passwort bestätigen *</label>
                <div class="relative">
                    <div class="absolute right-2 top-3 pr-0 cursor-pointer w-8 h-8" onclick="togglePW('passwordRepeat', 'svgPWRepeat')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"  class="w-8 h-8">
                    ...
                    <input name="password_confirmation" id="password_confirmation" required type="password" class="w-full" placeholder="Passwort eingeben" />
                </div>
