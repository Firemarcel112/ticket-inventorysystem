...
@section('content')
        ...
        <div class="ml-4 sm:ml-0 mb-8">
            ...
            <div id="BearbeitenMain">
                <form class="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]" method="POST" action="{{route('ticketstatusedit', $ticketstatus->id)}}">
                    @csrf
                    <x-form.input
                            label="Status"
                            inputName="name"
                    ...
                    <x-form.input
                            ...
                            :value="$ticketstatus->color"
                            setRequired="1"
                    ></x-form.input>

                    <div class="formButtons">
                        <x-button content="Speichern" colorType="success"></x-button>
                        <x-button type="1" :link="route('ticket.status.dashboard')" content="Abbrechen" colorType="danger"></x-button>
                    </div>
                </form>
            </div>
        </div>
